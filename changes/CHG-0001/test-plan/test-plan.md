...
| F3 resolved-while-live | `test_resolved_while_live_recompute_agrees_with_flag` | yes |
| F4 maintainer contagion | `test_contagion_matches_ground_truth` | yes |
| F5 typosquat candidates | `test_typosquats_found_ground_truth_recall_ge_0.8` | yes |
...
| F8 pipeline determinism | `test_gen_dataset_deterministic` (unit, two runs equal) | no |
