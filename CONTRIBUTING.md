...
## How a change flows
1. Open/claim a phase item in `vk/PROMPT.md` or file a `changes/CHG-XXXX/change.yaml`.
2. Read the governing docs (`AGENTS.md`, `vl/PLAN.md`, `DESIGN.md`, `docs/architecture/hydradb-notes.md`).
3. Implement one vertical slice; run the phase's checks; **save output to `.evidence/runs/<phase>/`**.
